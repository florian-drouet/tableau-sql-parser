...
import click
from utils import tree_output, generate_report
...
def main(file_to_parse, report_name, is_output):
   ...
   if is_output:
      generate_report(tables_names=tables_names, column_names=column_names, number_queries=number_queries, report_name=report_name)
